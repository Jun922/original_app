...
ActiveRecord::Schema.define(version: 2021_09_15_134046) do
  ...
  create_table "messages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["room2_id"], name: "index_messages_on_room2_id"
  ...
  create_table "room2s", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_room2s_on_user_id"
  end
  ...
  add_foreign_key "messages", "room2s"
